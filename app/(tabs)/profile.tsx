...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontFamily: 'PlusJakartaSans_800ExtraBold' },
  inputGroup: { marginBottom: Spacing.lg },
  label: { fontSize: 12, fontFamily: 'PlusJakartaSans_700Bold', letterSpacing: 1, marginBottom: 8 },
  ...
  infoTitle: { fontSize: 16, fontFamily: 'PlusJakartaSans_700Bold' },
