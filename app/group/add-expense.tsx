...
const styles = StyleSheet.create({
  ...
  headerTitle: { flex: 1, fontSize: 18, fontFamily: 'PlusJakartaSans_700Bold' },
  ...
  currencySymbol: { fontSize: 32, fontFamily: 'PlusJakartaSans_800ExtraBold', marginRight: 8 },
  amountInput: { flex: 1, fontSize: 36, fontFamily: 'PlusJakartaSans_800ExtraBold', padding: 0 },
  label: { fontSize: 12, fontFamily: 'PlusJakartaSans_700Bold', letterSpacing: 1, marginBottom: 8, marginTop: 16 },
  ...
  previewText: { fontSize: 14, fontFamily: 'PlusJakartaSans_700Bold' },
